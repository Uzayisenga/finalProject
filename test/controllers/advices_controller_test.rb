...
class AdvicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create advice" do
    assert_difference('Advice.count') do
      post advices_url, params: { advice: { advice: @advice.advice, email: @advice.email, field_in: @advice.field_in, name: @advice.name, time: @advice.time } }
    end
  ...
  test "should update advice" do
    patch advice_url(@advice), params: { advice: { advice: @advice.advice, email: @advice.email, field_in: @advice.field_in, name: @advice.name, time: @advice.time } }
